    ...
    <>
      {needsUserStart && !isReviewMode && (
        <button
          ...
          className="exam-control-button inline-flex min-h-9 w-full items-center justify-center gap-1.5 rounded border px-3 py-1.5 text-xs font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/30 sm:w-auto"
        >
      ...
      {showSkipSilence && (
        <div className="flex w-full items-stretch gap-1.5 sm:w-auto">
          <button
            type="button"
            onClick={() => void skipCurrentSilence()}
            className="exam-control-button inline-flex min-h-9 flex-1 items-center justify-center gap-1.5 rounded border px-3 py-1.5 text-xs font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/30 sm:flex-none"
          >
          ...
          <button
            type="button"
            onClick={() => setDismissedSilenceKey(activeSilenceKey)}
            aria-label="Dismiss skip silence"
            className="exam-icon-button inline-flex min-h-9 w-9 shrink-0 items-center justify-center rounded border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/30"
          >
      ...
      {showJumpToCurrentPart && (
        <div className="flex w-full items-stretch gap-1.5 sm:w-auto">
          <button
            type="button"
            onClick={() => void seekToPart(currentPart)}
            className="exam-control-button inline-flex min-h-9 flex-1 items-center justify-center gap-1.5 rounded border px-3 py-1.5 text-xs font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/30 sm:flex-none"
          >
            <SkipForward size={14} aria-hidden="true" />
        ...
        showActionsRow ? (
          <div className="pointer-events-none fixed left-0 right-0 top-[60px] z-40">
            <div className="mx-auto flex max-w-[1400px] justify-center px-2 sm:justify-end sm:px-4">
              <div
                className={`exam-audio-popout pointer-events-auto flex w-full max-w-[calc(100vw-1rem)] flex-wrap items-center gap-2 rounded-b-lg border border-t-0 px-2 py-2 shadow-lg backdrop-blur-sm sm:w-auto sm:px-3 ${isPopoutWiggling ? "exam-header-popout-wiggle" : ""}`}
              >
                {actionsContent}
              </div>
            </div>
